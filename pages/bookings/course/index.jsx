                        ...
                        <div className="md:mt-[80px] mt-[50] items-top md:px-7 px-5 md:py-7 py-5">
                           ...
                           >
                              ...
                              <div className="mb-10 mt-7">
                                 ...
                                 <div className="grid grid-cols-12 md:gap-5 gap-3 course-pricehidebox">
                                    {courseOptions.map((option) => (
                                       <div
                                          key={option.id}
                                          className="sm:col-span-4 col-span-6 my-3 flex justify-center"
                                       >
                                          <Field
                                             type="radio"
                                          ...
                                          <label
                                             htmlFor={option.id}
                                             className="w-full flex flex-col items-center  text-center bg-gray-100 py-4 px-5 rounded-lg border font-semibold text-secondary cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1 hover:bg-pmfLightGreen hover:bg-opacity-50 transition-all h-full"
                                          >
                                             <div className="w-full">
                                                <p className="font-bold md:text-2xl text-xl">{option.hour}</p>
                                                <p className="font-semibold text-xs">{option.variant}</p>
                                                <div>£{option.full}</div>
                                                <div className="text-[12px] font-normal py-2 leading-4 hidden md:block">
                                                   <p>{option.desc}</p>
                                                </div>
                                             </div>
                                          </label>
